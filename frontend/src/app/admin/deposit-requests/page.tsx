...
export default function AdminDepositRequestsPage() {
  ...
  const renderTable = (rows: DepositRequestRow[], emptyLabel: string) =>
    rows.length === 0 ? (
      ...
      <div className="hairline-border rounded-xl bg-card p-6">
        ...
        <Tabs defaultValue="pending" className="mt-4">
          ...
          <TabsContent value="pending">
            {renderTable(pending, "No pending deposit requests.")}
          </TabsContent>
          <TabsContent value="approved">
            {renderTable(approved, "No approved deposit requests yet.")}
          </TabsContent>
          <TabsContent value="rejected">
            {renderTable(rejected, "No rejected deposit requests.")}
          </TabsContent>
        </Tabs>
      </div>
